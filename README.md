# Gateway documentation OpenAPI Specification
[![Build Status](https://travis-ci.org/aurire/gtw-docu.svg?branch=master)](https://travis-ci.org/aurire/gtw-docu)
...
6. If you did everything correct, https://aurire.github.io/gtw-docu/ will lead to your new docs
...
- Documentation(ReDoc): https://aurire.github.io/gtw-docu/
- SwaggerUI: https://aurire.github.io/gtw-docu/swagger-ui/
- Look full spec:
    + JSON https://aurire.github.io/gtw-docu/swagger.json
    + YAML https://aurire.github.io/gtw-docu/swagger.yaml
- Preview spec version for branch `[branch]`: https://aurire.github.io/gtw-docu/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://aurire.github.io/gtw-docu/ with url from the message: `Server started <url>`
